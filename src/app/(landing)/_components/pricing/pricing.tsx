...
const Pricing = () => {
  return (
    <section className="container my-16">
      ...
      <h2 className="text-2xl md:text-3xl font-semibold">Pricing Plans for You</h2>
...
<div className="flex items-center gap-2 flex-col">
  ...
  <Button className="absolute top-1 right-1 h-[80%]">Apply</Button>
      ...
      <p className="text-[#4F516B] font-semibold text-center">🎁 I have a Referral Code/Coupon Code!</p>
      <p className="text-[#9A4D06] font-semibold text-center">To be paid as a one-time payment. Easy EMI options available with HDFC Cards and Zest Money.</p>
</div>
</div>
    </section>
  )
