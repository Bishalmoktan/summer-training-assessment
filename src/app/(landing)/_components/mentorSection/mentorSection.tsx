      ...
      <div className="flex gap-8 my-8">
        ...
        <div className="flex flex-col gap-2">
          <p className="font-light">
            Vivek has taught 10,000+ students through on campus workshops and
            online courses on Interview Preparation. He has worked at Amazon
            with its High Scale Systems for three years after graduating from
            IIT. He is loved by his students for his lucid in-depth explanations
            and ability to make people think through problems.
          </p>
          <div>
            <div className="font-semibold">Vivekan and Vivek</div>
            <div className="font-semibold flex gap-2">
              <p>IIT BHU Alumni, Ex-SDE</p>
              <Image src={amazonLogo} alt="Amazon" className="w-16 mt-1" />{" "}
            </div>
          </div>
